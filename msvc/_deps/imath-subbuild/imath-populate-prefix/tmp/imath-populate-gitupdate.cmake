...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v3.1.7"
  WORKING_DIRECTORY "N:/Development/Dev_Base/openexr-3.1.7/msvc/_deps/imath-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'N:/Development/Dev_Base/openexr-3.1.7/msvc/_deps/imath-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'N:/Development/Dev_Base/openexr-3.1.7/msvc/_deps/imath-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
